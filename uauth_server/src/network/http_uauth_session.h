...
class http_uauth_session:public std::enable_shared_from_this<http_uauth_session>
{
private:
    ...
    std::shared_ptr<http_uauth_handler> http_handler_ptr_ {nullptr};
...
public:
    explicit http_uauth_session(boost::asio::ip::tcp::socket&& socket,const boost::json::object& params,std::shared_ptr<spdlog::logger> logger_ptr);
    void session_run();
};
